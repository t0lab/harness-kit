...
- **Ink + React cho wizard TUI** — split-pane layout với Yoga flexbox; thống nhất một render model để tránh leak giữa inline log và alt-screen footer (chi tiết: `docs/design-docs/tui-architecture.md`)
